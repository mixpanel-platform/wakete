...
<head>
    <meta charset="UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=.7, maximum-scale=.7" />
	<title>Dogi Bubble Shooter</title>
	
	<!-- Standardised web app manifest -->
	<link rel="manifest" href="<?php echo url($path) ?>/appmanifest.json" />
...
function checkOrientation(){
	if(window.innerHeight < window.innerWidth){
		...
		$("#c2canvasdiv").css('display','initial');
	}
} 
...
$(window).resize(function(){
	checkOrientation();
	cr_sizeCanvas(jQuery(window).width(), (jQuery(window).height() - 66));
});			
