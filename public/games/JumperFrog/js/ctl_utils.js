...
function sizeHandler() {
	...
	var w = ( window.innerWidth < document.documentElement.clientWidth ?  window.innerWidth : document.documentElement.clientWidth );
	var h = ( window.innerHeight < document.documentElement.clientHeight ?  window.innerHeight : document.documentElement.clientHeight  ); 

    
        w = getSize("Width"); //Official 
        h = getSize("Height");
