ig.module(
	'plugins.css3-scaling'
).requires(
	'impact.input'
).defines(function() {
	CSS3Scaling = ig.Class.extend({
		offset: null,
		scale: null,
		init: function() {
			...
			ig.Input.inject({
				mousemove: function(event) {
					...
					this.mouse.x = (ev.pageX - ig.CSS3Scaling.offset[0]) / ig.CSS3Scaling.scale;
					this.mouse.y = (ev.pageY - ig.CSS3Scaling.offset[1]) / ig.CSS3Scaling.scale;
				}
			});
		},
		reflow: function() {
