...
<body> 
	...
	<div id="c2canvasdiv">
		...
		<canvas id="c2canvas" width="1280" height="760">
    ...
    <script>
		...
		$(document).ready(function(){
			juego();
			checkOrientation();
			cr_sizeCanvas(jQuery(window).width(), (jQuery(window).height() - $('header').height() ));
		});
      ...
      <script type="text/javascript">
        $(document).ready(function(){
                ...
                function resize() {
                    $('#c2canvasdiv').css({"height": '100%', "width": '100%',"margin-top":"0px", "margin-left" : "0px"});
