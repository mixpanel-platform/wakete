...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <!-- <link rel="stylesheet" id="css-theme" href="/oneui/assets/css/themes/flat.min.css"> -->
        <!-- END Stylesheets -->
    </head>
    <body>
        <!-- Maintenance Content -->
        <div class="content bg-white text-center pulldown overflow-hidden">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    ...
                    <h1 class="h2 font-w400 push-15 animated fadeInLeftBig">Lo sentimos, La web esta en construcción.</h1>
                    <h2 class="h3 font-w300 text-dark-op push-50 animated fadeInRightBig">Pronto estaremos activos</h2>
                </div>
            </div>
        </div>
